      ...
      <div style={{ maxWidth: '750px', margin: '0 auto', backgroundColor: 'white', padding: '30px', borderRadius: '14px', boxShadow: '0 4px 20px rgba(0,0,0,0.08)' }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '0' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', marginTop: '8px' }}>
            <button type="submit" style={{ flex: 1, backgroundColor: '#0ea5e9', color: 'white', padding: '14px', borderRadius: '8px', fontWeight: 'bold', border: 'none', cursor: 'pointer', fontSize: '15px' }}>
